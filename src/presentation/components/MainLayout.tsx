...
function GlobalSpeedDial() {
    const { openTransactionDialog, openBudgetDialog, openAiDialog } = useGlobalActions()
    const { speedDial } = useSpeedDialActions({ openTransactionDialog, openBudgetDialog, openAiDialog })
    return speedDial
}

function useSpeedDialActions({ openTransactionDialog, openBudgetDialog, openAiDialog }: any) {
    return {
        speedDial: (
            <SpeedDial
                actions={[
